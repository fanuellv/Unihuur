...
export default function Home() {
  return (
    <div className="font-[family-name:var(--font-geist-sans)]">
      <header className="flex top-0 left-0 w-full h-[100px] items-center bg-white justify-between p-2 pb-10 gap-2 sm:p-12 fixed z-100 shadow
      ">
        <Image
